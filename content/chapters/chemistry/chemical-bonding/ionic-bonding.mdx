...
<Quiz title="Ionic Bonding — quick check">
  ...
  <QuizQuestion question="Hydrogen chloride is covalent, yet its solution in water conducts electricity. Explain." options={["Ionic bonding is the transfer of electrons followed by attraction between the resulting ions — not sharing. Sharing electrons is covalent bonding; mixing the two up is a classic exam error.", "Drawing ionic bonding as sharing", "The attraction between positive metal ions and a sea of delocalised electrons.", "In water, HCl molecules release H⁺ ions (forming hydrochloric acid). These free-moving ions carry charge, so the solution conducts."]} answer={3} explanation="In water, HCl molecules release H⁺ ions (forming hydrochloric acid). These free-moving ions carry charge, so the solution conducts." />
  <QuizQuestion question="Explain why molten sodium chloride conducts electricity but solid sodium chloride does not." options={["Ionic bonding is the transfer of electrons followed by attraction between the resulting ions — not sharing. Sharing electrons is covalent bonding; mixing the two up is a classic exam error.", "The attraction between positive metal ions and a sea of delocalised electrons.", "Drawing ionic bonding as sharing", "Conduction needs mobile charged particles. In the solid the ions are locked in the lattice; when molten the ions are free to move and carry charge."]} answer={3} explanation="Conduction needs mobile charged particles. In the solid the ions are locked in the lattice; when molten the ions are free to move and carry charge." />
</Quiz>
