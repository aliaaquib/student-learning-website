...
<Quiz title="Metallic Bonding — quick check">
  ...
  <QuizQuestion question="Hydrogen chloride is covalent, yet its solution in water conducts electricity. Explain." options={["A shared pair of electrons between two atoms, usually two non-metals.", "Ionic bonding is the transfer of electrons followed by attraction between the resulting ions — not sharing. Sharing electrons is covalent bonding; mixing the two up is a classic exam error.", "An atom or molecule with an electric charge, formed by gaining or losing electrons.", "In water, HCl molecules release H⁺ ions (forming hydrochloric acid). These free-moving ions carry charge, so the solution conducts."]} answer={3} explanation="In water, HCl molecules release H⁺ ions (forming hydrochloric acid). These free-moving ions carry charge, so the solution conducts." />
</Quiz>
