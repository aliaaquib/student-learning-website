...
lede: "Investigate how warming and cooling change materials, and how to test fairly."
---

<LearningObjectives>
  <li>Define and explain Heating and Cooling in your own words</li>
...
<Definition term="Heating and Cooling">
...
<WorkedExample title="Worked example: Heating and Cooling">
...
<Quiz title="Heating and Cooling — quick check">
  <QuizQuestion question="Which of these best defines &quot;melt&quot;?" options={["To change from a liquid to a solid when cooled, like water turning to ice.", "A material that keeps its own shape, like a brick or an apple. It does not flow.", "A material that flows and takes the shape of its container, like water or milk.", "To change from a solid to a liquid when warmed, like ice turning to water."]} answer={3} explanation="To change from a solid to a liquid when warmed, like ice turning to water." />
  <QuizQuestion question="Sand pours like a liquid. Explain why scientists still call each grain a solid." options={["Gentle heating often just changes the state of a material, like melting butter. The butter is still butter, and cooling turns it solid again.", "Saying heating always destroys materials", "To change from a liquid to a solid when cooled, like water turning to ice.", "Each grain keeps its own shape and does not flow; only the pile of grains moves."]} answer={3} explanation="Each grain keeps its own shape and does not flow; only the pile of grains moves." />
</Quiz>
