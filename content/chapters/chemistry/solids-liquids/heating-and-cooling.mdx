...
<Quiz title="Heating and Cooling — quick check">
  ...
  <QuizQuestion question="Sand pours like a liquid. Explain why scientists still call each grain a solid." options={["Melting; yes, it is reversible because cooling the chocolate hardens it again.", "Cool it down and it freezes back into solid butter, showing no new material was made.", "The shape changes to fit the bottle, but the amount (volume) of water stays the same.", "Each grain keeps its own shape and does not flow; only the pile of grains moves."]} answer={3} explanation="Each grain keeps its own shape and does not flow; only the pile of grains moves." />
</Quiz>
