...
<Quiz title="Organic Synthesis — quick check">
  ...
  <QuizQuestion question="Name the structural isomers of C₄H₁₀." options={["A family of compounds with the same functional group and a general formula, e.g. alkanes CₙH₂ₙ₊₂.", "An electron-pair acceptor, attracted to electron-rich areas such as C=C double bonds.", "Compounds with the same molecular formula but different arrangements of atoms.", "Butane (CH₃CH₂CH₂CH₃) and methylpropane (CH₃CH(CH₃)CH₃)."]} answer={3} explanation="Butane (CH₃CH₂CH₂CH₃) and methylpropane (CH₃CH(CH₃)CH₃)." />
</Quiz>
