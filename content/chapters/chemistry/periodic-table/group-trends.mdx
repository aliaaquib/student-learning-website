...
<Quiz title="Trends in Groups — quick check">
  ...
  <QuizQuestion question="An element is dull, brittle and does not conduct electricity. Is it a metal or a non-metal? Where does it sit in the table?" options={["Reactivity varies hugely: potassium reacts violently with water while copper does not react at all. Position in the table gives trends, but the trend itself is what you must learn.", "Reading the group number as the total electrons", "The group number gives the number of outer-shell electrons, not the total. Chlorine in Group 7 has 7 outer electrons, but 17 electrons in total.", "A non-metal; non-metals sit to the right of the table."]} answer={3} explanation="A non-metal; non-metals sit to the right of the table." />
</Quiz>
