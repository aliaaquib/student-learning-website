...
<Quiz title="Changes of State — quick check">
  ...
  <QuizQuestion question="Why does diffusion happen faster in hot water than in cold water?" options={["The spreading of particles from an area of high concentration to an area of low concentration.", "Particles do not melt, expand or shrink — the substance does. Heating makes particles move faster and spread out; the particles themselves stay the same size.", "Saying particles melt", "Particles move faster when hot, so they spread and mix more quickly."]} answer={3} explanation="Particles move faster when hot, so they spread and mix more quickly." />
</Quiz>
