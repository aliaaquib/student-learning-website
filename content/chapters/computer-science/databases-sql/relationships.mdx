...
<Quiz title="Table Relationships — quick check">
  ...
  <QuizQuestion question="True or false: SQL tells the database exactly how to find the data, step by step." options={["A foreign key — it stores the primary key of a row in the Customers table, linking each order to its customer.", "One row: Leo — only Leo has Year 10.", "SELECT Title, Author FROM Books WHERE Year = 2010;", "False — SQL is declarative: you describe what you want and the database engine decides how to retrieve it."]} answer={3} explanation="False — SQL is declarative: you describe what you want and the database engine decides how to retrieve it." />
</Quiz>
