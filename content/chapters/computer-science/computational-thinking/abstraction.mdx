...
<Quiz title="Focusing on What Matters — quick check">
  ...
  <QuizQuestion question="True or false: computational thinking can only be used with computers." options={["Sometimes true", "Cannot be determined from the information given", "True", "False — it is a general problem-solving mindset that works for planning, studying and organising anything."]} answer={3} explanation="False — it is a general problem-solving mindset that works for planning, studying and organising anything." />
</Quiz>
