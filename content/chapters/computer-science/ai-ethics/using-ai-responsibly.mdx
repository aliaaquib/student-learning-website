...
<Quiz title="Using AI Responsibly — quick check">
  ...
  <QuizQuestion question="True or false: removing names from training data guarantees a model cannot discriminate." options={["True", "Sometimes true", "Cannot be determined from the information given", "False — remaining details like postcode or school can act as proxies for protected characteristics, so bias can survive."]} answer={3} explanation="False — remaining details like postcode or school can act as proxies for protected characteristics, so bias can survive." />
</Quiz>
