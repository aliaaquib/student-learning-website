...
<Quiz title="The binomial distribution — quick check">
  ...
  <QuizQuestion question="A test at the 5% level gives p-value 0.032. What is the conclusion?" options={["P = 6 × 0.2 × 0.8⁵ = 6 × 0.2 × 0.32768 = 0.393216.", "It specifies an increase only, so the critical region lies in a single (upper) tail of the distribution.", "0.5 — half the area lies above the mean.", "0.032 is less than 0.05, so reject H₀; there is sufficient evidence against the null hypothesis."]} answer={3} explanation="0.032 is less than 0.05, so reject H₀; there is sufficient evidence against the null hypothesis." />
</Quiz>
