...
<Quiz title="Hypothesis testing — quick check">
  ...
  <QuizQuestion question="For X ~ N(μ, σ²), what is P(X greater than μ)?" options={["1.5 — half the area lies above the mean.", "2.5 — half the area lies above the mean.", "5.5 — half the area lies above the mean.", "0.5 — half the area lies above the mean."]} answer={3} explanation="0.5 — half the area lies above the mean." />
</Quiz>
