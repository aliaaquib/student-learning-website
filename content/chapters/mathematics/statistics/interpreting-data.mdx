...
<Quiz title="Interpreting data honestly — quick check">
  ...
  <QuizQuestion question="A scatter diagram shows points rising left to right. What type of correlation is this?" options={["Finding the median without ordering the data", "Reading a truncated bar chart at face value", "The difference between the largest and smallest values, giving a simple measure of how spread out the data is.", "Positive correlation."]} answer={3} explanation="Positive correlation." />
</Quiz>
