...
<Quiz title="Measuring Development — quick check">
  ...
  <QuizQuestion question="Give one advantage and one disadvantage of debt relief." options={["Equating wealth with development", "A country can be rich in oil yet have poor schools and hospitals. Development means quality of life — health, education and opportunity — not just money.", "The Human Development Index: a composite measure combining life expectancy, education and income per person, scored from 0 to 1.", "Advantage: money once spent on debt repayments can fund schools and hospitals. Disadvantage: it may encourage irresponsible borrowing, or benefit corrupt governments rather than citizens."]} answer={3} explanation="Advantage: money once spent on debt repayments can fund schools and hospitals. Disadvantage: it may encourage irresponsible borrowing, or benefit corrupt governments rather than citizens." />
</Quiz>
