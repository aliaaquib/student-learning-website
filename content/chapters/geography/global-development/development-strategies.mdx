...
<Quiz title="Development Strategies — quick check">
  ...
  <QuizQuestion question="What is the Brandt Line?" options={["Equating wealth with development", "A country can be rich in oil yet have poor schools and hospitals. Development means quality of life — health, education and opportunity — not just money.", "The Human Development Index: a composite measure combining life expectancy, education and income per person, scored from 0 to 1.", "The imaginary line marking the broad economic divide between the richer global north and the poorer global south."]} answer={3} explanation="The imaginary line marking the broad economic divide between the richer global north and the poorer global south." />
</Quiz>
