...
<Quiz title="Reading Climate Graphs — quick check">
  ...
  <QuizQuestion question="Put these in order: condensation, precipitation, evaporation." options={["The warm North Atlantic Drift and prevailing south-westerly winds bring warm, moist air to the UK.", "Bars show monthly rainfall (mm); the line shows mean monthly temperature (°C).", "Natural: changes in solar output or volcanic eruptions. Human: burning fossil fuels, deforestation.", "Evaporation → condensation → precipitation."]} answer={3} explanation="Evaporation → condensation → precipitation." />
</Quiz>
