...
<Quiz title="Hormonal Control — quick check">
  ...
  <QuizQuestion question="Why is type 1 diabetes treated with insulin injections?" options={["In type 2 diabetes the pancreas produces little or no insulin, so blood glucose cannot be lowered after meals; injected insulin replaces the missing hormone.", "In type 3 diabetes the pancreas produces little or no insulin, so blood glucose cannot be lowered after meals; injected insulin replaces the missing hormone.", "In type 0 diabetes the pancreas produces little or no insulin, so blood glucose cannot be lowered after meals; injected insulin replaces the missing hormone.", "In type 1 diabetes the pancreas produces little or no insulin, so blood glucose cannot be lowered after meals; injected insulin replaces the missing hormone."]} answer={3} explanation="In type 1 diabetes the pancreas produces little or no insulin, so blood glucose cannot be lowered after meals; injected insulin replaces the missing hormone." />
</Quiz>
