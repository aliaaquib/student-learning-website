...
<Quiz title="The Carbon Cycle — quick check">
  ...
  <QuizQuestion question="Why do food chains rarely have more than five trophic levels?" options={["Only about 11% of energy transfers at each level, so after several transfers too little energy remains to support another trophic level.", "Only about 9% of energy transfers at each level, so after several transfers too little energy remains to support another trophic level.", "Only about 12% of energy transfers at each level, so after several transfers too little energy remains to support another trophic level.", "Only about 10% of energy transfers at each level, so after several transfers too little energy remains to support another trophic level."]} answer={3} explanation="Only about 10% of energy transfers at each level, so after several transfers too little energy remains to support another trophic level." />
</Quiz>
