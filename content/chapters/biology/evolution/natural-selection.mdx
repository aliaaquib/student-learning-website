...
<Quiz title="Natural Selection — quick check">
  ...
  <QuizQuestion question="Put these taxonomic groups in order from largest to smallest: genus, kingdom, species, class, phylum, family, order." options={["Individuals do not choose to evolve. Mutations create variation randomly; selection then favours the variants that happen to survive and reproduce better.", "Treating 'theory' as a guess", "In science, a theory is a well-tested explanation supported by extensive evidence. Evolutionary theory is supported by fossils, anatomy, embryology and DNA.", "Kingdom → phylum → class → order → family → genus → species."]} answer={3} explanation="Kingdom → phylum → class → order → family → genus → species." />
  <QuizQuestion question="Give two pieces of evidence for evolution besides fossils." options={["Treating 'theory' as a guess", "In science, a theory is a well-tested explanation supported by extensive evidence. Evolutionary theory is supported by fossils, anatomy, embryology and DNA.", "Individuals do not choose to evolve. Mutations create variation randomly; selection then favours the variants that happen to survive and reproduce better.", "Any two of: homologous structures; similar early embryos in vertebrates; DNA sequence comparisons showing closer relatives share more DNA."]} answer={3} explanation="Any two of: homologous structures; similar early embryos in vertebrates; DNA sequence comparisons showing closer relatives share more DNA." />
</Quiz>
