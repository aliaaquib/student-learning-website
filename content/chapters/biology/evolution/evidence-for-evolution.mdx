...
<Quiz title="Evidence for Evolution — quick check">
  ...
  <QuizQuestion question="Put these taxonomic groups in order from largest to smallest: genus, kingdom, species, class, phylum, family, order." options={["In science, a theory is a well-tested explanation supported by extensive evidence. Evolutionary theory is supported by fossils, anatomy, embryology and DNA.", "Body parts with the same basic structure but different functions, such as a human arm and a whale flipper, indicating common ancestry.", "Humans and chimpanzees share a common ancestor that lived millions of years ago; neither is descended from the other.", "Kingdom → phylum → class → order → family → genus → species."]} answer={3} explanation="Kingdom → phylum → class → order → family → genus → species." />
</Quiz>
