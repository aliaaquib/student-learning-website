...
<Quiz title="Classification and Phylogeny — quick check">
  ...
  <QuizQuestion question="Give two pieces of evidence for evolution besides fossils." options={["In science, a theory is a well-tested explanation supported by extensive evidence. Evolutionary theory is supported by fossils, anatomy, embryology and DNA.", "Body parts with the same basic structure but different functions, such as a human arm and a whale flipper, indicating common ancestry.", "The preserved remains or traces of an organism that lived long ago, providing evidence of how life has changed.", "Any two of: homologous structures; similar early embryos in vertebrates; DNA sequence comparisons showing closer relatives share more DNA."]} answer={3} explanation="Any two of: homologous structures; similar early embryos in vertebrates; DNA sequence comparisons showing closer relatives share more DNA." />
</Quiz>
