...
lede: "Explore the double circulatory system and how blood moves around the body."
---

<LearningObjectives>
  <li>Define and explain Heart and Circulation in your own words</li>
...
<Definition term="Heart and Circulation">
...
<WorkedExample title="Worked example: Heart and Circulation">
...
<PracticeQuestions>
  ...
  <PracticeItem question="A student counts 21 pulse beats in 15 seconds after exercise. Calculate the heart rate." hint="Multiply by 4.">
...
<Quiz title="Heart and Circulation — quick check">
  <QuizQuestion question="Which of these best defines &quot;double circulation&quot;?" options={["A biological catalyst, made of protein, that speeds up chemical reactions without being used up.", "A group of similar cells working together to carry out a particular function, such as muscle tissue or xylem tissue.", "A group of different tissues working together as a structure with a specific job, such as the stomach or a leaf.", "The two-loop circulatory system in mammals: one loop carries blood to the lungs, the other to the rest of the body."]} answer={3} explanation="The two-loop circulatory system in mammals: one loop carries blood to the lungs, the other to the rest of the body." />
  <QuizQuestion question="Name the three digestive enzymes and what each breaks down." options={["Any two of: large surface area; wall one cell thick for a short diffusion distance; rich blood supply to maintain a concentration gradient; many mitochondria for active transport.", "The left ventricle pumps blood all around the body, which needs much higher pressure than pumping blood the short distance to the lungs, so its muscle wall is thicker.", "Valves prevent the backflow of blood, keeping it moving in one direction through the heart and veins.", "Amylase breaks down starch (carbohydrate); protease breaks down protein; lipase breaks down lipids (fats)."]} answer={3} explanation="Amylase breaks down starch (carbohydrate); protease breaks down protein; lipase breaks down lipids (fats)." />
</Quiz>
