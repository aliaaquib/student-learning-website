...
<Quiz title="Heart and Circulation — quick check">
  ...
  <QuizQuestion question="Name the three digestive enzymes and what each breaks down." options={["A group of similar cells working together to carry out a particular function, such as muscle tissue or xylem tissue.", "A group of different tissues working together as a structure with a specific job, such as the stomach or a leaf.", "Arteries carry blood away from the heart (usually oxygenated); veins carry blood towards the heart (usually deoxygenated). The direction relative to the heart defines them, not the oxygen content.", "Amylase breaks down starch (carbohydrate); protease breaks down protein; lipase breaks down lipids (fats)."]} answer={3} explanation="Amylase breaks down starch (carbohydrate); protease breaks down protein; lipase breaks down lipids (fats)." />
</Quiz>
