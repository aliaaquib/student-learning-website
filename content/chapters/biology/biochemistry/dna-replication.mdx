...
<Quiz title="DNA Structure and Replication — quick check">
  ...
  <QuizQuestion question="Why does changing pH reduce the rate of an enzyme-controlled reaction?" options={["Replication is semi-conservative: each daughter molecule keeps one original strand and gains one new strand.", "Claiming both DNA strands are brand new after replication", "A small molecule that joins with others to form a polymer; for example, amino acids are the monomers of proteins.", "Hydrogen and ionic bonds in the enzyme are disrupted, changing the shape of the active site so the substrate no longer fits precisely; the enzyme is denatured and the rate falls."]} answer={3} explanation="Hydrogen and ionic bonds in the enzyme are disrupted, changing the shape of the active site so the substrate no longer fits precisely; the enzyme is denatured and the rate falls." />
</Quiz>
