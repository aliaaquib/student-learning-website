...
<Quiz title="Enzymes in Depth — quick check">
  ...
  <QuizQuestion question="Describe the result of a positive Biuret test and what it shows." options={["Enzymes are not alive, so they cannot be killed. High temperatures denature them by disrupting the bonds that hold their 3D shape.", "A small molecule that joins with others to form a polymer; for example, amino acids are the monomers of proteins.", "Saying high temperature kills enzymes", "The solution turns purple (from blue), which indicates the presence of protein."]} answer={3} explanation="The solution turns purple (from blue), which indicates the presence of protein." />
</Quiz>
