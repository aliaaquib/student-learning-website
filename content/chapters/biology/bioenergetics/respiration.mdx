...
<Quiz title="Aerobic and Anaerobic Respiration — quick check">
  ...
  <QuizQuestion question="On a graph of photosynthesis rate against light intensity, the curve levels off at high light. Explain why." options={["Photosynthesis builds glucose from carbon dioxide and water; respiration breaks glucose down. Mixing them up reverses the direction of energy flow.", "Plants respire all the time to release energy. At night photosynthesis stops but respiration continues.", "Claiming oxygen is the useful product of photosynthesis", "Light is no longer the limiting factor; something else, such as carbon dioxide concentration or temperature, is now in shortest supply, so extra light cannot raise the rate further."]} answer={3} explanation="Light is no longer the limiting factor; something else, such as carbon dioxide concentration or temperature, is now in shortest supply, so extra light cannot raise the rate further." />
</Quiz>
