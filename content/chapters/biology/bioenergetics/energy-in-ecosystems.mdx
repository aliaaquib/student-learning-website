...
<Quiz title="Energy in Ecosystems — quick check">
  ...
  <QuizQuestion question="Compare the products of anaerobic respiration in human muscle and in yeast." options={["Any two of: large surface area to catch light; thin for a short diffusion distance; chlorophyll in chloroplasts to trap light energy; stomata for gas exchange; veins to transport water and glucose.", "2 400 ÷ 20 000 = 0.12; 0.12 × 100 = 12% efficiency. The rest is lost through respiration, movement, excretion and uneaten parts.", "Glucose + oxygen → carbon dioxide + water (energy is released).", "In human muscle, anaerobic respiration converts glucose to lactic acid. In yeast, it converts glucose to ethanol and carbon dioxide."]} answer={3} explanation="In human muscle, anaerobic respiration converts glucose to lactic acid. In yeast, it converts glucose to ethanol and carbon dioxide." />
</Quiz>
