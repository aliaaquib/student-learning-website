...
<Quiz title="Quantum Ideas — quick check">
  ...
  <QuizQuestion question="A proton is uud. What is its total charge? (u = +2/3, d = −1/3)" options={["Two gamma-ray photons — annihilation converts their mass-energy into electromagnetic radiation.", "6.63 × 10⁻³⁴ × 6.0 × 10¹⁴ = 3.98 × 10⁻¹⁹ J ≈ 4.0 × 10⁻¹⁹ J.", "Red photons have lower frequency, so each carries less energy (E = hf) — below the work function — while violet photons exceed it.", "+2/3 + 2/3 − 1/3 = +1."]} answer={3} explanation="+2/3 + 2/3 − 1/3 = +1." />
</Quiz>
