...
<Quiz title="The Standard Model — quick check">
  ...
  <QuizQuestion question="What is produced when an electron meets a positron?" options={["A particle with the same mass but opposite charge to its partner; they annihilate on meeting.", "Protons are hadrons made of three quarks (uud) — quarks and electrons are the fundamental ones.", "A fundamental particle that makes up protons and neutrons; the common types are up and down.", "Two gamma-ray photons — annihilation converts their mass-energy into electromagnetic radiation."]} answer={3} explanation="Two gamma-ray photons — annihilation converts their mass-energy into electromagnetic radiation." />
</Quiz>
