---
title: "Matter Meets Antimatter"
lede: "Seeing how every particle has an antiparticle and what happens when they meet."
---

<LearningObjectives>
  <li>Define and explain Matter Meets Antimatter in your own words</li>
  <li>Use key terms such as antiparticle accurately</li>
...
<Definition term="Matter Meets Antimatter">
...
<WorkedExample title="Worked example: Matter Meets Antimatter">
...
<Quiz title="Matter Meets Antimatter — quick check">
  <QuizQuestion question="Which of these best defines &quot;antiparticle&quot;?" options={["A fundamental particle that makes up protons and neutrons; the common types are up and down.", "A packet (quantum) of electromagnetic energy with E = hf.", "A fundamental particle not made of quarks — electrons and neutrinos are leptons.", "A particle with the same mass but opposite charge to its partner; they annihilate on meeting."]} answer={3} explanation="A particle with the same mass but opposite charge to its partner; they annihilate on meeting." />
  <QuizQuestion question="Why does red light fail to release electrons from a metal when violet light succeeds?" options={["A fundamental particle not made of quarks — electrons and neutrinos are leptons.", "Calling protons fundamental particles", "A fundamental particle that makes up protons and neutrons; the common types are up and down.", "Red photons have lower frequency, so each carries less energy (E = hf) — below the work function — while violet photons exceed it."]} answer={3} explanation="Red photons have lower frequency, so each carries less energy (E = hf) — below the work function — while violet photons exceed it." />
</Quiz>
