...
<Quiz title="Matter Meets Antimatter — quick check">
  ...
  <QuizQuestion question="Why does red light fail to release electrons from a metal when violet light succeeds?" options={["Two gamma-ray photons — annihilation converts their mass-energy into electromagnetic radiation.", "6.63 × 10⁻³⁴ × 6.0 × 10¹⁴ = 3.98 × 10⁻¹⁹ J ≈ 4.0 × 10⁻¹⁹ J.", "+2/3 + 2/3 − 1/3 = +1.", "Red photons have lower frequency, so each carries less energy (E = hf) — below the work function — while violet photons exceed it."]} answer={3} explanation="Red photons have lower frequency, so each carries less energy (E = hf) — below the work function — while violet photons exceed it." />
</Quiz>
