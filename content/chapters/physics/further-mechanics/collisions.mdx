...
<Quiz title="Elastic and Inelastic Collisions — quick check">
  ...
  <QuizQuestion question="In SHM, where are speed and acceleration greatest?" options={["Force × time (FΔt), equal to the change in momentum.", "Treating momentum as a scalar", "Momentum has direction; opposite momenta subtract, which is why head-on collisions need a sign convention.", "Speed is greatest at equilibrium (maximum kinetic energy); acceleration is greatest at maximum displacement (maximum restoring force)."]} answer={3} explanation="Speed is greatest at equilibrium (maximum kinetic energy); acceleration is greatest at maximum displacement (maximum restoring force)." />
</Quiz>
