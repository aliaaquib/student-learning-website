...
lede: "Applying conservation of momentum to elastic and inelastic collisions."
---

<LearningObjectives>
  <li>Define and explain Elastic and Inelastic Collisions in your own words</li>
  <li>Use key terms such as momentum accurately</li>
...
<Definition term="Elastic and Inelastic Collisions">
...
<WorkedExample title="Worked example: Elastic and Inelastic Collisions">
...
<Quiz title="Elastic and Inelastic Collisions — quick check">
  <QuizQuestion question="Which of these best defines &quot;momentum&quot;?" options={["Force × time (FΔt), equal to the change in momentum.", "The resultant force towards the centre that keeps an object moving in a circle.", "Oscillation where acceleration is proportional to displacement and always towards equilibrium: a = −ω²x.", "Mass × velocity (p = mv), a vector quantity measured in kg m/s."]} answer={3} explanation="Mass × velocity (p = mv), a vector quantity measured in kg m/s." />
  <QuizQuestion question="In SHM, where are speed and acceleration greatest?" options={["Before: 2 × 3 = 6 kg m/s. After: 3 kg × v = 6, so v = 2 m/s.", "They increase the time over which momentum changes, so the average force on the passenger is smaller.", "√(0.2 ÷ 80) = √0.0025 = 0.05, so T = 2π × 0.05 ≈ 0.31 s.", "Speed is greatest at equilibrium (maximum kinetic energy); acceleration is greatest at maximum displacement (maximum restoring force)."]} answer={3} explanation="Speed is greatest at equilibrium (maximum kinetic energy); acceleration is greatest at maximum displacement (maximum restoring force)." />
</Quiz>
