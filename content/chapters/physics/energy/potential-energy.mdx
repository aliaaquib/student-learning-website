...
lede: "Working with gravitational potential energy, E = mgh, and stored elastic energy."
---

<LearningObjectives>
  <li>Define and explain Potential Energy in your own words</li>
  <li>Use key terms such as gravitational potential energy accurately</li>
...
<Definition term="Potential Energy">
...
<WorkedExample title="Worked example: Potential Energy">
...
<Quiz title="Potential Energy — quick check">
  <QuizQuestion question="Which of these best defines &quot;gravitational potential energy&quot;?" options={["The fraction of input energy usefully transferred, usually given as a percentage.", "The unit of energy, symbol J. Lifting a small apple one metre takes about 1 J.", "Energy stored in a moving object: E = ½ × mass × velocity².", "Energy stored by lifting an object: E = mass × g × height."]} answer={3} explanation="Energy stored by lifting an object: E = mass × g × height." />
  <QuizQuestion question="A 3 kg book is lifted 2 m (g = 10 N/kg). Find its gain in GPE." options={["Kinetic energy depends on v², so doubling v multiplies the energy by 2² = 4.", "None is lost — some transfers to thermal energy and sound in the ball and ground on each bounce.", "Chemical energy (battery) → electrical energy → light energy, plus some thermal energy in the bulb.", "3 × 10 × 2 = 60 J."]} answer={3} explanation="3 × 10 × 2 = 60 J." />
</Quiz>
