...
<Quiz title="Sound Needs a Medium — quick check">
  ...
  <QuizQuestion question="Tightening a guitar string raises the note. Why?" options={["Space is a vacuum with no particles, so sound cannot travel between them — they use radios instead.", "Steel is faster: about 5000 m/s in steel versus about 343 m/s in air.", "The pitch — hertz measures frequency, which determines pitch.", "A tighter string vibrates faster — higher frequency means a higher pitch."]} answer={3} explanation="A tighter string vibrates faster — higher frequency means a higher pitch." />
</Quiz>
