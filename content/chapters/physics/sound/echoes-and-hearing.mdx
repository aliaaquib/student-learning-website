...
<Quiz title="Echoes and Hearing — quick check">
  ...
  <QuizQuestion question="Tightening a guitar string raises the note. Why?" options={["The size of a vibration; a bigger amplitude means a louder sound.", "Thinking sound travels in space", "A reflected sound wave that arrives back at the listener after bouncing off a surface.", "A tighter string vibrates faster — higher frequency means a higher pitch."]} answer={3} explanation="A tighter string vibrates faster — higher frequency means a higher pitch." />
</Quiz>
