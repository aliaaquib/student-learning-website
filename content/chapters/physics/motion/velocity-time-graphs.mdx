...
<Quiz title="Velocity–Time Graphs — quick check">
  ...
  <QuizQuestion question="A car travels at a steady 25 m/s for 40 s. How far does it go?" options={["The object is stationary — distance is not changing as time passes.", "Yes — its direction is changing, so its velocity is changing, which means it is accelerating even though its speed is constant.", "(22 − 10) ÷ 6 = 12 ÷ 6 = 2 m/s².", "25 × 40 = 1000 m."]} answer={3} explanation="25 × 40 = 1000 m." />
</Quiz>
