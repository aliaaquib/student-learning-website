...
<Quiz title="Reflection and Refraction — quick check">
  ...
  <QuizQuestion question="An EM wave has wavelength 0.5 m. Calculate its frequency (c = 3 × 10⁸ m/s)." options={["Longitudinal — air particles vibrate parallel to the direction the sound travels, in compressions and rarefactions.", "Refraction — light slows down in glass, and the change in speed at the boundary bends the ray.", "Microwaves: cooking food, mobile phone and satellite communication. Infrared: overexposure can cause skin burns.", "3 × 10⁸ ÷ 0.5 = 6 × 10⁸ Hz."]} answer={3} explanation="3 × 10⁸ ÷ 0.5 = 6 × 10⁸ Hz." />
</Quiz>
