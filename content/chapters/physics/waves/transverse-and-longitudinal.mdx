...
<Quiz title="Transverse and Longitudinal — quick check">
  ...
  <QuizQuestion question="A ray of light bends as it enters glass from air. Name the effect and explain why it happens." options={["3 × 10⁸ ÷ 0.5 = 6 × 10⁸ Hz.", "Longitudinal — air particles vibrate parallel to the direction the sound travels, in compressions and rarefactions.", "Microwaves: cooking food, mobile phone and satellite communication. Infrared: overexposure can cause skin burns.", "Refraction — light slows down in glass, and the change in speed at the boundary bends the ray."]} answer={3} explanation="Refraction — light slows down in glass, and the change in speed at the boundary bends the ray." />
</Quiz>
