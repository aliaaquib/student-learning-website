...
<Quiz title="Development Strategies — quick check">
  ...
  <QuizQuestion question="Give one advantage and one disadvantage of FDI for a developing country." options={["They combined export-led growth with heavy state investment in education and infrastructure.", "A cycle where low income means low saving and investment, which keeps income low.", "Any one of: ignores health and education, ignores inequality, ignores the environment and unpaid work.", "Advantage: jobs, capital and technology. Disadvantage: profits flow abroad; the country may depend on foreign firms."]} answer={3} explanation="Advantage: jobs, capital and technology. Disadvantage: profits flow abroad; the country may depend on foreign firms." />
</Quiz>
