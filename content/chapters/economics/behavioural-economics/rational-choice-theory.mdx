...
lede: "Examine the traditional model of the rational consumer."
---

<LearningObjectives>
  <li>Define and explain Rational Choice Theory in your own words</li>
...
<Definition term="Rational Choice Theory">
...
<WorkedExample title="Worked example: Rational Choice Theory">
...
<Quiz title="Rational Choice Theory — quick check">
